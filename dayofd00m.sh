...
if [ ! -f "./d00mer-$PAM_VERSION.so" ]; then
	echo ""
	echo -e "${RED}[-]${NC} no d00mer-$PAM_VERSION.so file, compile it first."
	echo ""
	exit 1
fi; 
echo ""
